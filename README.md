...
* Content authoring in Markdown with simple access to React components
...
* Blazingly fast, simple webfonts
...
* Build-time type-checking, unit testing, and integration testing on story content
